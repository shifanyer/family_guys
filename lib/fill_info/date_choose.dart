...
class ChooseDate extends StatefulWidget {
  final ValueChanged<PickerDateRange> datesRange;

  const ChooseDate({Key? key, required this.datesRange}) : super(key: key);

  @override
  ChooseDateState createState() => ChooseDateState();
}
                ...
                */
                Positioned(
                  ...
                  child: SfDateRangePicker(
                    ...
                    onSubmit: (value) {
                      widget.datesRange(value as PickerDateRange);
